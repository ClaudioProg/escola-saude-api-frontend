...
export default function QRCodesEventosAdmin() {
  ...
  return (
    <main className="min-h-screen bg-gelo dark:bg-zinc-900 px-4 py-6 max-w-5xl mx-auto text-black dark:text-white">
      <Breadcrumbs trilha={[{ label: "Painel administrador" }, { label: "QR Codes de Presença" }]} />
      <CabecalhoPainel titulo="🔳 QR Codes de Presença por Turma" />
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="bg-lousa hover:bg-green-800 text-white text-sm font-semibold px-3 py-1.5 rounded transition"
                        >
                          Gerar PDF
                        </button>
                      </li>
